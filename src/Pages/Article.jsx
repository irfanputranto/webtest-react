          ...
          <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-4">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full px-3">
                        ...
                        <input type="file" className="file-input file-input-bordered w-full max-w-xs" id="image"
                ...
                <div className="w-full px-3 mt-2">
                        ...
                        <input type="file" className="file-input file-input-bordered w-full max-w-xs" id="video"
